		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[FI] 고객별 매출 조회 ",
									"targetURL": "#synce17synce17-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce17synce17-display": {
								"semanticObject": "synce17synce17",
								"action": "display",
								"description": "[FI] 고객별 매출 조회 ",
								"title": "[FI] 고객별 매출 조회 ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e17.sync.e17",
									"url": sap.ui.require.toUrl("sync/e17/sync/e17")
								}
							}
						}
					}
