		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[직영점] 재고이전 결재 프로그램",
									"targetURL": "#synce17inventory4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce17inventory4-display": {
								"semanticObject": "synce17inventory4",
								"action": "display",
								"description": "[직영점] 재고이전 결재 프로그램",
								"title": "[직영점] 재고이전 결재 프로그램",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e17.inventory4",
									"url": sap.ui.require.toUrl("sync/e17/inventory4")
								}
							}
						}
					}
