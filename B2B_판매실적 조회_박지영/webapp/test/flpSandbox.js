		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "한국타이어",
									"targetURL": "#synceacompany2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceacompany2-display": {
								"semanticObject": "synceacompany2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.company2",
									"url": sap.ui.require.toUrl("sync/ea/company2")
								}
							}
						}
					}
