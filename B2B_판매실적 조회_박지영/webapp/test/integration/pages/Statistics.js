			...
			assertions: {
				...
				iShouldSeeTheCharts: function () {
					if (sChartViewName.search("D3") >= 0) {
						this.waitFor({
							controlType: "sync.ea.company2.control.D3PieChart",
							viewName: sChartViewName,
						...
						this.waitFor({
							controlType: "sync.ea.company2.control.D3ColumnChart",
							viewName: sChartViewName,
							success: function (aCharts) {
						...
						this.waitFor({
							controlType: "sync.ea.company2.control.D3ComparisonChart",
							viewName: sChartViewName,
							success: function (aCharts) {
						...
						this.waitFor({
							controlType: "sync.ea.company2.control.D3Chart",
							viewName: sChartViewName,
							success: function (aCharts) {
