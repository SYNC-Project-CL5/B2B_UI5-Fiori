sap.ui.define([
	...
	return BaseController.extend("sync.ea.company2.controller.App", {
		...
		onItemSelect: function(oEvent) {
			...
			if (sKey === "home" || sKey === "masterSettings" || sKey === "statistics") {
				...
				// switch 문을 사용하여 클릭된 아이템에 따라 링크로 이동하도록 처리합니다.
				switch (sKey) {
					case "Usage Statistics was pressed":
						window.location.href = "https://edu.bgis.co.kr:8443/sap/bc/ui2/flp#synceasales2-display";
						break;
					case "Order Statistics was pressed":
						window. location.href = "https://edu.bgis.co.kr:8443/sap/bc/ui2/flp?sap-ui-xx-noless&sap-theme=custom_tire@https://edu.bgis.co.kr:8443/sap/bc/theming/themes/~client-100&theme=custom_tire#synceadispo-display";
						break;
					case "Important Links was pressed":
						window.location.href = "https://edu.bgis.co.kr:8443/sap/bc/ui2/flp#synceacompany1-display";
						break;
					case "Legal was pressed":
						window.location.href = "https://edu.bgis.co.kr:8443/sap/bc/ui2/flp#syncealogin-display";
						// 로그아웃 연결 (혜진)
						break;
					case "재고를 조회합니다":
						window.location.href = "https://edu.bgis.co.kr:8443/sap/bc/ui2/flp#synceastock-display";
						// 직영점 재고 조회 연결 (혜진)
						break;
					case "재고이전을 요청합니다":
						window.location.href = "https://edu.bgis.co.kr:8443/sap/bc/ui2/flp#transportingtfr-display";
						// 재고이전 요청 연결 (연범)
						break;
					case "재고요청건을 결재합니다":
						window.location.href = "https://edu.bgis.co.kr:8443/sap/bc/ui2/flp#synce17inventory4-display";
						break;
					default:
						break;
				}
...
//   return Controller.extend("sync.ea.company2.controller.App", {
//     //   onSideNavButtonPress: function () {
//     //       // 사이드 네비게이션 토글 로직
//     //   },
