		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "직영점 판매실적 조회",
									"targetURL": "#synceasales2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceasales2-display": {
								"semanticObject": "synceasales2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.sales2",
									"url": sap.ui.require.toUrl("sync/ea/sales2")
								}
							}
						}
					}
