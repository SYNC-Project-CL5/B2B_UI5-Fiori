		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "tfr",
									"targetURL": "#transportingtfr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"transportingtfr-display": {
								"semanticObject": "transportingtfr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=transporting.tfr",
									"url": sap.ui.require.toUrl("transporting/tfr")
								}
							}
						}
					}
