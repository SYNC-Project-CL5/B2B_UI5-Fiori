		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "B2C 고객 판매 오더 조회",
									"targetURL": "#synceab2csalesorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceab2csalesorder-display": {
								"semanticObject": "synceab2csalesorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.b2csalesorder",
									"url": sap.ui.require.toUrl("sync/ea/b2csalesorder")
								}
							}
						}
					}
