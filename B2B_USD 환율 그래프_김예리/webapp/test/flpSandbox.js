		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[FI] 환율그래프",
									"targetURL": "#sync08zeafi050-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync08zeafi050-display": {
								"semanticObject": "sync08zeafi050",
								"action": "display",
								"description": "[FI] 환율그래프",
								"title": "[FI] 환율그래프",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync08.zeafi050",
									"url": sap.ui.require.toUrl("sync08/zeafi050")
								}
							}
						}
					}
